                ...
                <Head>
                    ...
                    <div id="all">
                        <div className="pl-[1.25rem] pr-[1rem] xl:px-[200px] sm:px-0 sm:pl-[2rem] md:pr-[20px]" id="container-project-henryfood">
                            ...
                            <Link href='https://henryfood.vercel.app'>
                            <a target='_blank' rel="noreferrer">
                                <div id='firtProject' className='mb-4 min-w-[450px] h-[65vh] sm:mr-[2rem] lg:mr-[9px] md:h-[97vh] lg:h-[103vh] sm:h-[72vh] xl:h-screen lg:w-full xl:w-full md:w-full bg-gradient-to-tr to-teal-900 via-sky-700 from-blue-300'>
