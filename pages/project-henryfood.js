                    ...
                    <div id="all">
                        <div className="pl-[25px] pr-[20px] xl:px-[200px] sm:px-0 sm:pl-[2rem] md:pr-[20px]" id="container-project-henryfood">
                            <div className="grid min-w-[350px] pt-24 mb-16 sm:mb-14 sm:pt-32 xl:ml-0 lg:ml-0 xl:mb-20">
                                <h3 className="text-5xl md:text-5xl min-w-[650px] xl:text-6xl lg:text-5xl sm:text-4xl xl:max-w-2xl">Mi primer aplicación web de cocina (Full Stack)</h3>
                            ...
                            <Link href='https://henryfood.vercel.app'>
                            <a target='_blank' rel="noreferrer">
                                <div id='firtProject' className='mb-4 min-w-[720px] h-[78vh] sm:mr-[2rem] lg:mr-[9px] md:h-[97vh] lg:h-[103vh] sm:h-[72vh] xl:h-screen lg:w-full xl:w-full md:w-full bg-gradient-to-tr to-teal-900 via-sky-700 from-blue-300'>
