...
class PopsOut extends React.Component {   
    render() {
        return <>
                <Head>
                    <title>Portfolio Project - popsout</title>
                </Head>
                    <div id="all">
                        <div className="pl-[25px] pr-[20px] xl:px-[200px] sm:px-0 sm:pl-[2rem] md:pr-[20px]" id="container-project-popsout">
                            <div className="grid min-w-[350px] pt-24 mb-16 sm:mb-14 sm:pt-32 xl:ml-0 lg:ml-0 xl:mb-20">
                                <h3 className="text-5xl md:text-5xl min-w-[650px] md:min-w-[1000px] xl:text-6xl lg:text-5xl sm:text-4xl xl:max-w-2xl">Landing Page PopsOut (Front End)</h3>
                                <span className="pt-4 text-lg md:text-xl xl:text-2xl lg:text-xl pb-9 sm:text-lg text-neutral-500">Una bonita Landing Page con estéticas animaciones.</span>
