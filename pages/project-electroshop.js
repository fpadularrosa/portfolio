        ...
        <>
                <Head>
                    ...
                    <div className="lg:ml-0"  id="all">
                        <div className="pl-[1.25rem] pr-[1rem] xl:px-[200px] lg:pr-0 sm:px-0 sm:pl-[2rem] md:pr-[20px]"  id="container-project-electroshop">
                            <div className="grid pt-24 mb-16 sm:mb-14 sm:pt-32 xl:ml-0 lg:ml-0 xl:mb-20">
                            ...
                            <Link href='https://electroshop-ecommerce.vercel.app'>
                            <a target='_blank' rel="noreferrer">
                                <div id='secondProject' className='mb-4 sm:mr-[2rem] h-[65vh] lg:mr-[9px] md:h-[100vh] lg:h-[120vh] sm:h-[70vh] xl:h-screen lg:w-full xl:w-full md:w-full bg-gradient-to-tr to-pink-600 via-pink-500 from-pink-300'>
                        ...
                        <div className="flex mt-8 mb-24 justify-evenly" id="container-utils-project">
                            <div className="flex justify-center" id="myRole">
                                <div>
                                    <div className="mb-3 text-lg xl:text-xl" id="titleRol">Mi rol</div>
                                    <div className="text-sm xl:text-lg text-neutral-500" id="examples">
                                        Front End <br/>
                                        Back End <br/>
                                    </div>
                                </div>
                            ...
                            <div className="ml-24" id="tools">
                                <div className="mb-3 text-lg xl:text-xl" id="titleTools">Herramientas</div>
                                <div className="text-sm xl:text-lg text-neutral-500" id="examples-tools">
                                    React <br/>
                                    Redux <br/>
                                    JavaScript <br/>
                                    Sequelize <br/>
                            ...
                            <div id="website">
                                <div className="mb-3 text-lg xl:text-xl" id="title">Sitio web</div>
                                <div className='inline-block mt-4 font-medium transition duration-300 ease-in border-b-2 rounded-md xl:text-xl text-md hover:border-b-2 hover:border-gray-500 text-neutral-900 hover:text-neutral-500' id='linkToProject1'>
                                    <Link href='https://electroshop-ecommerce.vercel.app'>
                                        <a target='_blank' rel="noreferrer">
