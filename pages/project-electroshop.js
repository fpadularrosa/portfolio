                    ...
                    <div className="lg:ml-0"  id="all">
                        <div className="pl-[1.25rem] pr-[1rem] xl:px-[200px] lg:pr-0 sm:px-0 sm:pl-[2rem] md:pr-[20px]"  id="container-project-electroshop">
                            <div className="grid min-w-[350px] pt-24 mb-16 sm:mb-14 sm:pt-32 xl:ml-0 lg:ml-0 xl:mb-20">
                                <h3 className="text-5xl md:text-5xl xl:text-6xl lg:text-5xl sm:text-4xl xl:max-w-2xl">Proyecto Grupal en Henry</h3>
                            ...
                            <Link href='https://electroshop-ecommerce.vercel.app'>
                            <a target='_blank' rel="noreferrer">
                                <div id='secondProject' className='mb-4 min-w-[450px] sm:mr-[2rem] h-[65vh] lg:mr-[9px] md:h-[100vh] lg:h-[120vh] sm:h-[70vh] xl:h-screen lg:w-full xl:w-full md:w-full bg-gradient-to-tr to-pink-600 via-pink-500 from-pink-300'>
