  ...
  return (
    ...
    <Head>
      ...
      <meta charSet="utf-8"/>
        ...
        <div className="mt-[92px] mb-40 mx-5 xl:mx-32 xl:pl-7 sm:my-28 sm:mx-0 md:mx-0 md:mb-52 lg:mb-48 md:mt-36 lg:mt-24 lg:mr-2 md:mr-0" id="container-home">
            <div className='grid xl:text-left justify-items-center xl:justify-around md:pl-0 md:grid lg:pl-0 md:m-0 xl:flex lg:justify-around lg:flex sm:grid sm:justify-items-center'>
                <div className="grid xl:pt-36 xl:ml-7 lg:pt-28" id="text-home">
                    <div className="mr-0 overflow-hidden sm:ml-6 lg:mr-8" id="container-text">
                        <h1 className='xl:text-left text-5xl max-w-[620px] lg:text-5xl sm:text-4xl lg:max-w-lg xl:text-6xl pb-7 sm:pb-5 sm:max-w-[630px] xl:max-w-2xl xl:leading-tight md:text-6xl md:max-w-7xl'>
                        Hola, soy Franco.<br/>
                ...
                <div className="xl:max-w-[50%] max-w-[70%] ml-14 sm:mt-9 md:ml-[240px] xl:ml-10 lg:ml-0 md:mt-20 xl:mr-0 sm:pr-10 lg:mr-[-20px] lg:max-w-[560px] sm:max-w-sm md:max-w-[32rem] lg:h-[80%] lg:mt-12 xl:mt-8 md:h-[650px] sm:m-auto">
