const Footer = () => {
    return(
        <>
        <footer className='bottom-0 md:w-[180vh] sm:pt-24 lg:w-[195vh] xl:w-full bg-black md:mt-44'>
            <div id='first-container-footer' className="text-white xl:flex sm:grid md:flex lg:pb-20 lg:flex lg:justify-start lg:justify-items-start md:pb-12 sm:pb-16 md:mr-0 xl:mx-64 md:justify-items-start xl:justify-items-start">
                <div className='xl:mt-[84px] md:mr-28 sm:pr-28 xl:pr-24 pr-0 sm:mt-0 lg:ml-7 lg:mr-32 sm:ml-5 sm:mb-8 md:mt-[74px] lg:mt-12 md:mb-8'>
                    <div className='font-semibold md:pb-3 sm:mb-7 lg:text-lg sm:text-lg md:text-lg xl:text-xl'>Feliz hablando de:</div>
                        <div className='xl:text-lg sm:text-md md:text-md justify-evenly'>
                            ...
                            Estrategía
                            <br/>
                            Educación/Upskilling
                            </div>
                        </div>
                    </div>
                    <div className='xl:pt-6 sm:ml-5 lg:mt-8 lg:ml-7 xl:pb-8 md:mt-14 lg:mb-12 md:mb-8'>
                        <div className='font-semibold xl:pb-4 md:pb-3 lg:text-lg xl:text-xl sm:py-3 sm:text-lg md:pt-4 md:text-lg xl:pt-7'>Ponte en contácto conmigo</div>
            ...
            <div id='second-container-footer' className='grid w-full pr-0 text-white justify-items-center lg:pr-2 lg:pl-7 xl:justify-items-center sm:justify-items-start sm:pl-5'>
                <hr className="md:w-[98%] xl:w-[70%] lg:w-[98%] sm:w-[97%]" width='45%'/>
