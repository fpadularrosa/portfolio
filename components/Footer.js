const Footer = () => {
    return(
        <>
        <footer className='bottom-0 w-[145vh] sm:w-[145vh] sm:pt-24 lg:w-full md:w-full xl:w-full bg-black md:mt-44'>
            <div id="container-footer">
                <div className="mx-5 text-white pt-14 xl:flex sm:grid md:flex lg:pb-20 lg:flex lg:justify-start lg:justify-items-start md:pb-12 sm:pb-16 md:mr-0 xl:mx-64 md:justify-items-start xl:justify-items-start">
                ...
                <div className='grid w-full pr-0 text-white justify-items-center lg:pr-2 lg:pl-7 xl:justify-items-center sm:justify-items-start sm:pl-5'>
