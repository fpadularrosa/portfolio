    ...
    return(
        <nav className="fixed top-0 left-0 z-10 w-full bg-gradient-to-b from-white to-transparent">
            <div className="flex justify-between mx-5 mt-2 md:pr-[26px] md:pl-[20px] text-gray-700 sm:mx-0 lg:pl-0 lg:justify-between lg:mx-6 xl:mx-0 xl:mr-12 xl:ml-0 xl:mt-5 xl:pl-12 xl:justify-between md:justify-between sm:justify-between">
                ...
                <ul className="items-center hidden space-x-1 text-base cursor-pointer lg:flex lg:pr-0 pr-52 xl:pr-10">
                    <Link href='/#expertise'>
                    ...
                    <Link href='/#projects'>
                        <a className="duration-500 hover:cursor-pointer hover:text-neutral-300">
                            <li className="inline-block py-1 mx-3 text-xl text-black transition ease-in border-b-2 rounded-md duration-400 border-neutral-300 hover:border-b-2 hover:border-black xl:text-lg hover:text-neutral-300">Portfolio</li>
                        </a>
                    </Link>
                    <Link href='/about-franco'>
                        <a className="duration-500 hover:cursor-pointer hover:text-neutral-300">
                            <li className="inline-block py-1 ml-[16px] mr-6 text-xl text-black transition ease-in border-b-2 rounded-md duration-400 border-neutral-300 hover:border-b-2 hover:border-black xl:text-lg hover:text-neutral-300">Sobre mi</li>
                        </a>
                    </Link>
                    <div className='inline-block border-black border-2 hover:cursor-pointer hover:text-black hover:bg-neutral-100 px-8 py-3 ml-5 text-lg text-white transition duration-200 ease-in bg-black xl:px-8 xl:items-center xl:justify-center xl:flex xl:ml-6 lg:ml-5 lg:mr-3 h-14 xl:h-[52px]'>
                        <Link href='/contact'>
                            <a>
                                <div className="">  
                                    Hablemos
