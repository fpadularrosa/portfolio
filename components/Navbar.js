...
const Navbar = () => {
    ...
    return(
        <nav className="fixed top-0 left-0 z-10 w-full bg-gradient-to-b from-white to-transparent">
            <div className="flex justify-between mx-4 text-gray-700 sm:mx-0 lg:pl-0 lg:justify-between md:pl-0 md:mx-5 lg:mx-6 xl:mx-10 xl:pl-14 xl:m-auto xl:justify-between md:justify-between sm:justify-between">
