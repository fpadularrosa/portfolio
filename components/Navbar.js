...
const Navbar = () => {
    ...
    return(
        <nav className="fixed top-0 left-0 z-10 w-full bg-gradient-to-b from-white to-transparent">
            <div className="flex justify-between mx-5 md:pr-[26px] md:pl-[20px] text-gray-700 sm:mx-0 lg:pl-0 lg:justify-between lg:mx-6 xl:mx-10 xl:pl-14 xl:m-auto xl:justify-between md:justify-between sm:justify-between">
                <div className='lg:mr-14 xl:pl-[94px] xl:max-w-[11%] max-w-[12%] lg:max-w-[8%] md:max-w-[9%] sm:max-w-[14%] sm:pl-6 md:mr-6 md:pl-0'>
                    <Link href='/'>
                        <a>
