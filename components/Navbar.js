...
const Navbar = () => {
    ...
    return(
        <nav className="fixed top-0 left-0 z-10 w-full bg-gradient-to-b from-white to-transparent">
            <div className="flex justify-between mx-5 md:pr-[26px] md:pl-[20px] text-gray-700 sm:mx-0 lg:pl-0 lg:justify-between lg:mx-6 xl:mx-0 xl:pl-12 xl:justify-between md:justify-between sm:justify-between">
                <div className='lg:mr-14 xl:pl-[47px] xl:max-w-[10%] max-w-[12%] lg:max-w-[8%] md:max-w-[9%] sm:max-w-[14%] sm:pl-6 md:mr-6 md:pl-0'>
                    <Link href='/'>
                        <a>
                ...
                <ul className="items-center hidden text-base cursor-pointer lg:flex lg:pr-0 pr-52 xl:pr-10">
                    <Link href='/#expertise'>
                        <a className="duration-500 hover:cursor-pointer hover:text-neutral-300">
                            <li className="inline-block py-1 mx-4 text-xl text-black transition ease-in border-b-2 rounded-md duration-400 border-neutral-300 hover:border-b-2 hover:border-black xl:text-xl hover:text-neutral-300">Experiencia</li>
                        </a>
                    </Link>
                    <Link href='/#portfolio'>
                        <a className="duration-500 hover:cursor-pointer hover:text-neutral-300">
                            <li className="inline-block py-1 mx-4 text-xl text-black transition ease-in border-b-2 rounded-md duration-400 border-neutral-300 hover:border-b-2 hover:border-black xl:text-xl hover:text-neutral-300">Portfolio</li>
                        </a>
                    </Link>
                    <Link href='/about-franco'>
                        <a className="duration-500 hover:cursor-pointer hover:text-neutral-300">
                            <li className="inline-block py-1 mx-4 text-xl text-black transition ease-in border-b-2 rounded-md duration-400 border-neutral-300 hover:border-b-2 hover:border-black xl:text-xl hover:text-neutral-300">Sobre mi</li>
                        </a>
                    </Link>
                    <div>
                        <Link href='/contact'>
                            <a>
                                <div className="px-8 py-3 ml-5 text-lg text-white transition duration-200 ease-in bg-black xl:px-9 xl:py-4 xl:ml-7 lg:ml-5 lg:mr-3 hover:cursor-pointer hover:border hover:border-black hover:text-black hover:bg-neutral-100 h-14 xl:h-[60px]">
                                    Hablemos
                                </div>
                            </a>
                        </Link>
