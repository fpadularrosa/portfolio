...
const Portfolio = () => {
    return(
        <>
            <section data-aos='fade' data-aos-once='true'  className='mt-20  w-full grid justify-items-center xl:w-[94%] sm:pl-9 lg:ml-[20px] md:mr-7 lg:pr-8 lg:w-[98%] md:mb-32 ml-0 md:pl-7 md:w-[175vh] xl:ml-4 sm:mb-20' id="container-portfolio">
                <div className='xl:w-[94%] lg:w-full md:w-[175vh] xl:ml-[185px] mx-6' id="container2-portfolio">
                    <div id="title" className='mb-10 text-4xl xl:pb-10 md:pb-9 sm:text-4xl sm:pb-8 md:text-4xl xl:text-5xl md:ml-0 xl:flex xl:justify-start'>
                    ...
                    <div className='' id="projects">
                        <div className='mb-20 xl:mb-32' id="container2-projects">
                            ...
                            <a>
                                <div id='firtProject' className='mb-4 sm:mr-10 xl:mr-0 xl:relative xl:h-[98vh] md:h-[128vh] sm:h-[76vh] xl:w-11/12 md:w-full bg-gradient-to-tr to-teal-900 via-sky-700 from-blue-300'>
                                    <div className='md:ml-[2.5rem] py-5 md:grid xl:ml-[5rem] md:justify-items-start sm:ml-[2rem] sm:grid sm:justify-items-start xl:grid xl:place-items-start'>
                                        ...
                                        <div className='w-[90%] xl:w-[90%] ml-5 sm:w-[96%]'>
                                            <div className='transition-all h-[280px] duration-300 transform shadow-2xl sm:h-[220px] md:w-full sm:w-full xl:w-full xl:hover:scale-110 lg:hover:scale-110' id='project1'>
                            ...
                            <div id='2Project' className='mb-4 mt-20 sm:mr-10 xl:mr-0 xl:relative xl:h-[98vh] md:h-[128vh] sm:h-[76vh] xl:w-11/12 md:w-full bg-gradient-to-tr to-pink-600 via-pink-500 from-pink-300'>
                                    <div className='md:grid py-5 md:ml-[2.5rem] xl:ml-[5rem] md:justify-items-start sm:ml-[2rem] sm:grid sm:justify-items-start xl:grid xl:place-items-start'>
                                        ...
                                        <div className='w-[90%] xl:w-[90%] ml-5 sm:w-[96%]'>
                                            <div className='transition-all h-[280px] duration-300 transform shadow-2xl sm:h-[220px] md:w-full sm:w-full xl:w-full xl:hover:scale-110 lg:hover:scale-110' id='imgProject1'>
