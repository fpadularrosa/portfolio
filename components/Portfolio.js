...
const Portfolio = () => {
    return(
        <>
            <section className='mt-20 w-full pr-[25px] pl-[25px] min-w-[500px] sm:pr-[30px] sm:pl-[30px] grid justify-items-center xl:w-[93%] lg:pl-[35px] lg:pr-[20px] lg:w-[97%] md:pr-[30px] md:pl-[30px] md:mb-32 md:w-full xl:pr-[35px] xl:pl-[40px] sm:mb-20' id="container-portfolio">
                <div className='xl:w-[92%] lg:w-full md:w-[170vh] xl:ml-[185px]' id="container2-portfolio">
                    ...
                    <div className='' id="projects">
                        <div className='mb-20 xl:mb-32' id="container2-projects">
                            ...
                            <a>
                                <div id='firtProject' className='mb-4 xl:mr-0 xl:relative xl:h-[107vh] h-[68vh] md:h-[128vh] sm:h-[83vh] xl:w-11/12 lg:w-full md:w-full bg-gradient-to-tr to-teal-900 via-sky-700 from-blue-300'>
                            ...
                            <a>
                            <div id='2Project' className='mb-4 mt-20 xl:mr-0 xl:relative h-[68vh] xl:h-[107vh] md:h-[128vh] sm:h-[83vh] xl:w-11/12 md:w-full bg-gradient-to-tr to-pink-600 via-pink-500 from-pink-300'>
