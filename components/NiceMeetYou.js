    ...
    return(
        <div className='ml-0 xl:flex xl:justify-evenly xl:ml-3 xl:mx-18 md:ml-6 sm:ml-6' id='nicetoMeetYou'>
            <div className='grid content-center mx-5 xl:mb-0 md:mb-7 sm:mb-20'>
                ...
                <p className='xl:max-w-lg min-w-[250px] sm:text-lg xl:my-5 sm:my-4 xl:text-[23px] md:max-w-2xl md:text-xl md:mt-4 text-neutral-500'>Amo resolver problemas reales con profesionales amigables y gente increible!</p>
