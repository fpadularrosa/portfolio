...
const NiceMeetYou = () => {
    return(
        <div className='px-6 py-16 ml-0 cel:px-0 xl:my-40 lg:mr-0 lg:ml-0 md:px-0 xl:mx-0 md:ml-0 sm:ml-6' id='nicetoMeetYou'>
            <div className='flex flex-col xl:flex-row xl:justify-around sm:flex lg:flex-row lg:justify-around cel:px-6 xl:items-center lg:mx-7 md:px-0 lg:pl-0 xl:ml-0 xl:mb-0 md:flex-col md:ml-6 md:mb-20 xl:mx-0'>
                ...
                <div className='md:ml-0 mt-16 mb-28 mx-0 xl:mr-5 xl:ml-0 lg:mx-0 lg:my-0 min-w-[250px] md:my-0 md:w-[520px] sm:ml-3 xl:w-[520px] xl:h-[420px] sm:w-[440px] sm:h-[380px]'>
