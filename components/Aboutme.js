...
const Aboutme = () => {
    return(
        <>
            <div className="grid grid-rows-2 mb-20 mt-32 sm:pl-[24px] sm:pr-[24px] sm:pt-24 xl:px-52 md:pt-28 md:px-8 xl:pt-32" id='container-aboutme-c'>
                ...
                <div className="mt-10 ml-[120px] lg:mt-32 md:mt-24 sm:mt-32 xl:mt-8 xl:ml-40 lg:ml-24">
                    <div className="xl:w-[95%] w-[70%] sm:w-[85%] md:w-[80%] lg:w-[90%] lg:h-[70%] xl:h-[85%]">
