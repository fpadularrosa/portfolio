        ...
        <>
            <div className="grid grid-rows-2 xl:flex lg:flex md:flex mb-20 mt-32 sm:pl-[24px] sm:pr-[24px] sm:pt-24 xl:px-52 md:pt-28 md:px-8 xl:pt-20" id='container-aboutme-c'>
                <div className='mx-6 lg:ml-6 sm:pr-12 lg:grid lg:justify-start lg:mb-12 xl:ml-0 md:mr-24' id="container-aboutme">
                    ...
                    En el 2021 me decidí a estudiar programación y entré al bootcamp Henry porque quiero independizarme y desde hace muchos años que me atrae el mundo del software, actualmente estoy egresado del mismo mientras estoy en busqueda activa laboral y mantengo mi learner mindset aprendiendo tecnologías como Nest, Next, Firebase.<br/><br/>
