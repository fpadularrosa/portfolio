...
const Projects = () => {
    return(
        <>
            <section className='mt-20 xl:mt-28 md:min-w-[768px] flex justify-center sm:px-0 xl:w-full xl:pl-0 lg:pl-[10px] lg:pr-[20px] lg:w-full md:pt-20 md:my-0 md:pr-0 md:pl-0 md:pb-32 md:w-full xl:pr-0 xl:ml-0 sm:mb-20' id="container-portfolio">
                <div className='flex flex-col justify-center cel:px-6 xl:w-[90%] lg:w-full xl:px-5 md:px-6' id="container2-portfolio">
                    ...
                    <div className='' id="projects">
                        <div className='mb-20 xl:mb-32' id="container2-projects">
                            ...
                            <a>
                                <div id='firtProject' className='mb-10 xl:mr-0 xl:relative xl:h-[130vh] h-[45vh] md:h-[110vh] sm:h-[80vh] xl:w-[98%] lg:h-[105vh] lg:w-full md:w-full bg-gradient-to-tr to-slate-700 via-slate-500 from-blue-200'>
                                    <div className='py-5 md:mx-8 md:grid xl:ml-[3rem] md:justify-items-start sm:ml-[1rem] sm:mr-[1rem] sm:grid sm:justify-items-start xl:flex xl:justify-start xl:flex-col'>
                                        ...
                                        <div className='xl:w-[90%] ml-5 lg:w-full lg:pr-4 sm:w-[96%]'>
                                            <div className='transition-all h-full duration-300 transform drop-shadow-2xl w-[90%] md:w-full sm:w-full xl:w-full lg:w-full xl:hover:scale-110 lg:hover:scale-110' id='project1'>
                            ...
                            <a>
                            <div id='2Project' className='mb-4 xl:mr-0 xl:relative xl:h-[130vh] h-[45vh] md:h-[110vh] sm:h-[80vh] xl:w-[98%] lg:h-[105vh] lg:w-full md:w-full bg-gradient-to-tr to-pink-600 via-pink-500 from-pink-300'>
                                    <div className='md:grid py-5 md:mx-8 xl:ml-[3rem] md:justify-items-start sm:ml-[1rem] sm:mr-[1rem] sm:grid sm:justify-items-start xl:grid xl:place-items-start'>
                                        ...
                                        <div className='w-full sm:w-auto xl:w-[93%] lg:w-full lg:pr-4 ml-5'>
                                            <div className='transition-all h-full duration-300 transform drop-shadow-2xl shadow-2xl w-[90%] md:w-full sm:w-full xl:w-full xl:hover:scale-110 lg:hover:scale-110' id='imgProject2'>
                            ...
                            <a>
                            <div id='3Project' className='mb-4 xl:mt-0 xl:mr-0 xl:relative xl:h-[130vh] h-[45vh] md:h-[110vh] sm:h-[80vh] xl:w-[98%] lg:h-[105vh] lg:w-full md:w-full bg-gradient-to-bl to-purple-800 via-purple-500 from-purple-100'>
                                    <div className='md:grid py-5 md:mx-8 xl:ml-[3rem] md:justify-items-start sm:ml-[1rem] sm:mr-[1rem] sm:grid sm:justify-items-start xl:grid xl:place-items-start'>
                                        ...
                                        <div className='sm:w-auto xl:w-[93%] lg:w-full lg:pr-4 ml-5'>
                                            <div className='transition-all h-full duration-300 transform drop-shadow-2xl shadow-2xl w-[90%] md:w-full sm:w-full xl:w-full xl:hover:scale-110 lg:hover:scale-110' id='imgProject3'>
                                ...
                                <div id='titleProject2'>
                                    <h3 className='max-w-lg text-xl sm:max-w-md sm:text-[20px]'>Landing page con animaciones estéticas para tu sitio web.</h3>
                                    <div className='flex flex-row mt-4 space-x-2'>
                                        <div className='flex justify-center w-32 bg-black rounded-lg h-9 sm:w-32'>
                                            <div className='m-2 text-white text-sm sm:text-[15px]'>Desarrollo Web</div>
                                        </div>
                                ...
                                <div className='inline-block text-xl font-medium transition sm:mb-14 ease-in border-b-2 sm:text-[19px] sm:mt-12 rounded-md duration-400 mt-14 xl:mt-14 md:mt-7 hover:border-b-2 hover:border-gray-500 text-neutral-900 hover:text-neutral-500' id='linkToProject1'>
                                    <Link href='/project-popsout'>
                                        <a>
                                        <div className='hover:cursor-pointer'>Ver proyecto</div>
                                        </a>
