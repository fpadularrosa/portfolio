                ...
                <div className='xl:w-[95%] lg:w-full md:w-[195vh] flex-col flex justify-center ' id="container2-portfolio">
                    ...
                    <div className='' id="projects">
                        <div className='mb-20 xl:mb-32' id="container2-projects">
                            ...
                            <a>
                                <div id='firtProject' className='mb-10 xl:mr-0 xl:relative xl:h-[132vh] h-[85vh] md:h-[128vh] sm:h-[80vh] xl:w-[98%] lg:w-full md:w-full bg-gradient-to-tr to-slate-700 via-slate-500 from-blue-200'>
                                ...
                                <div className='inline-block text-xl font-medium transition ease-in-out border-b-2 xl:mb-16 rounded-md sm:text-[19px] duration-400 mt-14 sm:mt-12 hover:border-b-2 hover:border-gray-500 text-neutral-900 hover:text-neutral-500' id='linkToProject1'>
                                    <Link href='/project-henryfood'>
                                        <a>
                            ...
                            <a>
                            <div id='3Project' className='mb-4 xl:mt-16 xl:mr-0 xl:relative xl:h-[132vh] h-[85vh] md:h-[128vh] sm:h-[80vh] xl:w-[98%] lg:w-full md:w-full bg-gradient-to-bl to-purple-800 via-purple-500 from-purple-100'>
                                    <div className='md:grid py-5 md:mx-8 xl:ml-[3rem] md:justify-items-start sm:ml-[1rem] sm:mr-[1rem] sm:grid sm:justify-items-start xl:grid xl:place-items-start'>
