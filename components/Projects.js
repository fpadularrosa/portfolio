...
const Projects = () => {
    return(
        <>
            <section className='mt-20 xl:mt-28 w-full pr-[25px] pl-[25px] min-w-[800px] sm:min-w-[815px] md:min-w-[768px] flex justify-center sm:pr-[30px] sm:pl-[30px] xl:w-[93%] lg:pl-[35px] lg:pr-[20px] lg:w-full md:pt-20 md:my-0 md:pr-0 md:pl-0 md:pb-32 md:w-full xl:pr-0 xl:ml-[32px] sm:mb-20' id="container-portfolio">
                <div className='xl:w-[96%] lg:w-full xl:pl-1 xl:pr-0 md:w-full md:px-6 flex-col flex justify-center ' id="container2-portfolio">
                    ...
                    <div className='' id="projects">
                        <div className='mb-20 xl:mb-32' id="container2-projects">
                            ...
                            <a>
                                <div id='firtProject' className='mb-10 xl:mr-0 xl:relative xl:h-[120vh] h-[85vh] md:h-[110vh] sm:h-[80vh] xl:w-[98%] lg:h-[105vh] lg:w-full md:w-full bg-gradient-to-tr to-slate-700 via-slate-500 from-blue-200'>
                                    <div className='py-5 md:mx-8 md:grid xl:ml-[3rem] g md:justify-items-start sm:ml-[1rem] sm:mr-[1rem] sm:grid sm:justify-items-start xl:flex xl:justify-start xl:flex-col'>
                                        ...
                                        <div className='w-full xl:w-[93%] ml-5 lg:w-full lg:pr-4 sm:w-[96%]'>
                                            <div className='transition-all h-[220px] duration-300 transform drop-shadow-2xl w-[70%] sm:h-[220px] md:w-full sm:w-full xl:w-full lg:w-full xl:hover:scale-110 lg:hover:scale-110' id='project1'>
                                ...
                                <div className='inline-block text-xl font-medium transition lg:mb-16 ease-in-out md:mb-16 border-b-2 xl:mb-16 rounded-md sm:text-[19px] duration-400 mt-14 sm:mt-12 hover:border-b-2 hover:border-gray-500 text-neutral-900 hover:text-neutral-500' id='linkToProject1'>
                                    <Link href='/project-henryfood'>
                                        <a>
                            ...
                            <a>
                            <div id='2Project' className='mb-4 xl:mr-0 xl:relative xl:h-[120vh] h-[85vh] md:h-[110vh] sm:h-[80vh] xl:w-[98%] lg:h-[105vh] lg:w-full md:w-full bg-gradient-to-tr to-pink-600 via-pink-500 from-pink-300'>
                                ...
                                <div className='inline-block text-xl font-medium transition lg:mb-16 md:mb-16 ease-in border-b-2 sm:text-[19px] sm:mt-12 rounded-md duration-400 mt-14 xl:mt-14 md:mt-7 hover:border-b-2 hover:border-gray-500 text-neutral-900 hover:text-neutral-500' id='linkToProject1'>
                                    <Link href='/project-electroshop'>
                                        <a>
                                        <div className='hover:cursor-pointer'>Ver proyecto</div>
                                        </a>
                            ...
                            <a>
                            <div id='3Project' className='mb-4 xl:mt-16 xl:mr-0 xl:relative xl:h-[120vh] h-[85vh] md:h-[110vh] sm:h-[80vh] xl:w-[98%] lg:h-[105vh] lg:w-full md:w-full bg-gradient-to-bl to-purple-800 via-purple-500 from-purple-100'>
                                    <div className='md:grid py-5 md:mx-8 xl:ml-[3rem] md:justify-items-start sm:ml-[1rem] sm:mr-[1rem] sm:grid sm:justify-items-start xl:grid xl:place-items-start'>
