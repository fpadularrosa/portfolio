...
const Expertise = () => {
    return(
        <>
            <section className="mx-6 cel:ml-0 cel:mr-0 xl:px-0 xl:mx-0 lg:pl-[10px] md:mr-0 lg:pr-0 sm:mr-[1.5rem] sm:ml-0" id='expertise'>
                <div className="js-show-on-scroll pl-[21px] ml-0 sm:ml-9 md:ml-6 xl:flex xl:flex-col lg:ml-0 sm:mr-16 md:mx-6 md:px-0 lg:pr-0 xl:mx-0 xl:px-0 md:pl-0" id='container-expertise'>
                    <div className="flex mb-6 xl:ml-[80px]" id="title">
                        <h2 className='xl:text-[45px] drop-shadow-md shadow-red-200 min-w-[300px] text-4xl md:ml-0 lg:text-5xl lg:ml-4 md:font-thin md:text-4xl sm:text-4xl xl:ml-3'>Mi experiencia</h2>
                    </div>

                    <div className='sm:py-12 lg:ml-0 lg:flex lg:flex-row lg:justify-center xl:justify-center xl:space-x-5 lg:space-x-6 md:ml-0 sm:pb-24 md:flex md:flex-row md:space-x-10 xl:flex xl:py-0 xl:pt-12 xl:flex-row xl:ml-2 xl:mr-5 sm:justify-items-center' id="content">
